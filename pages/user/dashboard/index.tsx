...
import Highcharts, {Options, SeriesPieOptions, XrangePointOptionsObject} from 'highcharts'
...
export default function Dashboard({ user }: InferGetServerSidePropsType<typeof getServerSideProps>) {
	...
	return (
		<UserLayout title="Overview" user={user}>
								...
								<div className="transition duration-500 group card shadow rounded-md bg-white text-center outline-white hover:outline-blue ">
									<div className="card-body p-4 lg:p-6">
										...
										<CircularProgressbar value={60} text={`${60}%`}
											strokeWidth={5} styles={buildStyles({
												pathColor: '#FACA30', textColor: 'black'
											})}
											className="max-h-52 my-2"
										/>
									</div>
...
const scatterChartData: Options = {
	chart: {
		type: 'scatter',
		zoomType: 'xy'
	},
